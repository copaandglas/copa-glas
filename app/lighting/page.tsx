    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        >
          ...
          <span className="opacity-25 mx-2">/</span>
          <span className="opacity-90">Lighting</span>
        </motion.nav>
        ...
        >
          ...
          to order in our East London workshop, where the same material
          language carried through our mirrors is drawn into the glow of a room.
        </motion.p>
      </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className="
                      absolute inset-0 bg-black/0 sm:group-hover:bg-black/20
        ...
        >
          <div className="max-w-xl">
            ...
            <h2
              ...
              "
            >
              Lighting, made for the room it lives in.
            </h2>
            <p
              className="
                font-[family-name:var(--font-playfair),Georgia,serif]

...
const editions: Edition[] = [
  {
    ...
    image: "/frank-lloyd-wright-mirror-main.jpg",
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        >
          ...
          <span className="opacity-25 mx-2">/</span>
          <span className="opacity-90">Limited Editions</span>
        </motion.nav>
              ...
              >
                ...
                <div className="pt-4 sm:pt-4 md:pt-5 lg:pt-6">
                  <h2
                    className="
                      font-[family-name:var(--font-playfair),Georgia,serif]
                      text-[1.375rem] sm:text-[1.25rem] md:text-[1.5rem] lg:text-[1.625rem] 3xl:text-[1.75rem]
        ...
        >
          <div className="max-w-xl">
            ...
            >
              ...
              signed from the studio. To enquire about availability within a
              run, or to be introduced to a forthcoming edition, please write
              to us directly.
            </p>
          </div>
          ...
          <Link
            ...
            style={{ color: "#fff" }}
          >
            <span>Enquire About an Edition</span>
            <svg
              width="14"
              height="14"
              viewBox="0 0 24 24"
